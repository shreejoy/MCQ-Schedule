          ...
          >
            ...
            <Modal.Body>
              <Alert variant={"danger"}>
                <b>Remember:</b> Once the question is submitted it cannot be
                modified. So, Please verify the question once again before
                confirming. Once verified, Press the "Understood" button.
              </Alert>
              <>
                <b>Question:</b>
                <pre style={styles.pre}>{this.state.data.question}</pre>
              </>
              {this.state.data.code && (
                <>
                  <b>Code:</b>
                  <pre style={styles.pre}>{this.state.data.code}</pre>
                </>
              )}
              {this.state.data.explaination && (
                <>
                  <b>Explaination:</b>
                  <pre style={styles.pre}>{this.state.data.explaination}</pre>
                </>
              )}
              <>
                <b>Options:</b>
                {[
                  ...
                  <pre
                    key={idx}
                    style={
                      !option.includes(this.state.data.correct_option)
                        ? styles.pre
                        : { color: "green", ...styles.pre }
                    }
                  >
                    <b>
                      {option.split("_")[1]} {">"}
